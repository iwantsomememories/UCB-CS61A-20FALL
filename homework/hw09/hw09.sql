...
CREATE TABLE siblings AS
  SELECT a.child AS first, b.child AS second, c.size AS size FROM parents AS a, parents AS b, size_of_dogs AS c, size_of_dogs as d WHERE a.parent = b.parent AND a.child < b.child AND a.child = c.name AND b.child = d.name AND c.size = d.size;
